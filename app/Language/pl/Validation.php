...
return [
    ...
    'not_in_list'           => 'Pole {field} nie może mieć jednej z wartości: {param}.',
    ...
    'ci_not_equals'         => 'Pole {field} nie może mieć wartości: {param}; bez uwzględniania wielkości liter.',
    'ci_in_list'            => 'Pole {field} musi być jednym z: {param}; bez uwzględniania wielkości liter.',
    'ci_not_in_list'        => 'Pole {field} nie może mieć jednej z wartości: {param}; bez uwzględniania wielkości liter.',
    'recaptcha'             => 'Pole {field} nie jest poprawne.'
];
